...
interface OperationStandardInterface extends ethers.utils.Interface {
  functions: {
...
export class OperationStandard extends BaseContract {
  ...
  interface: OperationStandardInterface;
