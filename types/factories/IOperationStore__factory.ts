...
import type {
  IOperationStore,
  IOperationStoreInterface,
} from "../IOperationStore";
...
export class IOperationStore__factory {
  static readonly abi = _abi;
  static createInterface(): IOperationStoreInterface {
    return new utils.Interface(_abi) as IOperationStoreInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IOperationStore {
    return new Contract(address, _abi, signerOrProvider) as IOperationStore;
  }
}
